...
export default function Terms() {
  const sections = [
    ...
    },
    {
      ...
      content: `2.1 Scope: </br><p style="padding-left: 10px;">• You get access to premium content in our Database. </p><p style="padding-left: 10px;">• Service lasts for three years after payment. </p>2.2 Exclusivity: <p style="padding-left: 10px;">• Only these T&C apply to our agreement. </p><p style="padding-left: 10px;">• Other terms from you or third parties don’t apply. </p>2.3 Modifications: <p style="padding-left: 10px;">• We may update these T&C, but we’ll notify you in writing first. </p><p style="padding-left: 10px;">• Changes take effect once we’ve let you know and you acknowledge them.</p> `,
    },
    {
      title: "PAYMENT CONDITIONS",
      content:
        "3.1 You’ll get access to the service only after you’ve paid the Service Fee in full.</br>3.2 Please pay by bank transfer or check to our specified account. Your access starts once we receive your payment.",
    },
    {
      title: "RIGHT OF WITHDRAWAL",
      content: `4.1 Contract Formation: </br><p style="padding-left: 10px;">• The agreement is binding once you pay the Service Fee in response to our offer. </p>4.2 Withdrawal Period: <p style="padding-left: 10px;">• You can cancel within seven days of payment, no questions asked. </p><p style="padding-left: 10px;">• The agreement starts as soon as you pay. </p>`,
    },
    {
    ...
    },
    {
      ...
      content: `6.1 Overview: </br><p style="padding-left: 10px;">• After payment, we may offer to publish an article highlighting your brand’s achievements. </p>6.2 Purpose: </br><p style="padding-left: 10px;">• This helps showcase and strengthen your brand’s reputation. </p>6.3 Editorial Rights: </br><p style="padding-left: 10px;">• We may edit submitted content for clarity and consistency, but won’t change the facts. </p>6.4 Disclaimer: </br><p style="padding-left: 10px;">• We’re not liable for any damages related to this optional service. </p>`,
    },
    {
      title: "DURATION AND TERMINATION",
      content: `7.1 Contract Period: </br><p style="padding-left: 10px;">• The agreement ends automatically after one year and can’t be terminated early for ordinary reasons. </p>7.2 Termination for Cause: </br><p style="padding-left: 10px;">• Either party can end the agreement immediately if there’s a serious breach. </p><p style="padding-left: 10px;">• The breaching party should be given a chance to fix issues within a reasonable time. </p><p style="padding-left: 10px;">• If it’s unreasonable to continue, immediate termination is allowed. </p>`,
    },
    {
      title: "REFUND POLICY",
      content:
    ...
    },
    {
      ...
      content: `9.1 Jurisdiction: </br><p style="padding-left: 10px;">• Our agreement and these T&C are governed by United States law. </p>9.2 Dispute Resolution: </br><p style="padding-left: 10px;">• We’ll try to resolve any issues amicably. </p><p style="padding-left: 10px;">• If that doesn’t work, legal action can be taken in a competent court. </p>`,
    },
    {
      title: "DATA PRIVACY",
