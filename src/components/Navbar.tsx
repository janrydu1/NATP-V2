          ...
          <Link to="/" className="flex items-center gap-1">
            <svg
              ...
              <g mask="url(#mask1_1_65)">
                <path
                  d="M684.182 342.901H593.411C593.411 204.349 480.698 91.6354 342.156 91.6354C203.62 91.6354 90.8906 204.349 90.8906 342.901H0.119812C0.119812 238.573 46.5156 141.38 129.536 74.8646C179.302 35.0156 239.521 10.0573 302.891 3.04167C408.651 -8.66666 510.224 27.2552 584.005 101.052C648.604 165.661 684.182 251.552 684.182 342.901Z"
                  fill="black"
                />
              </g>
            </svg>
